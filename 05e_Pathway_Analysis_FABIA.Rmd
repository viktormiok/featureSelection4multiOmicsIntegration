---
title: "Pathway Analysis for FABIA (1 ~ 10 Bicluster FABIA, Top 5% features per bicluster)"
author: "John Zhuang"
date: "2024-06-17"
...
The results here are deprecated in favor of FABIA variables selected using thres_L (extractBic()).
...
```{r}
results.fabia = readRDS("data/sel_features/results_fabia_top_5_percent.rds")
...
geneNames <- list("Factor1of1"= multiomics.to.GENES(names(sel.features$`1bc`$bicluster1)),
                  ...
                  "Factor5of10"= multiomics.to.GENES(names(sel.features$`10bc`$bicluster5)),
...
```{r}
saveRDS(geneNames, file = "data/sel_features/gene_converted/genes_fabia_top_5_percent.rds")
```
...
saveRDS(pathway, file = "data/out_pathway/pathways_fabia_top_5_percent.rds")
```
